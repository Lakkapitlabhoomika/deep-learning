...
sns.heatmap(cm, annot=True, fmt='g', linewidths=.5, ax=ax)
ax.xaxis.set_ticklabels(['Normal', 'Seizure']); ax.yaxis.set_ticklabels(['Normal', 'Seizure'])
